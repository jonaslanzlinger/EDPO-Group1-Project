...
public class HBW_1 extends Station {
    ...
    public HBW_1(String id, String station, String timestamp, double i1_light_barrier, double i2_light_barrier, double i3_light_barrier, double i4_light_barrier, double i5_pos_switch, double i6_pos_switch, double i7_pos_switch, double i8_pos_switch, double m1_speed, double m2_speed, double m3_speed, double m4_speed, String current_state, String current_task, double current_task_duration, String current_sub_task, String failure_label, double current_pos_x, double current_pos_y, double target_pos_x, double target_pos_y, int amount_of_workpieces, Map<String, String> current_stock) {
        super(id, station);
