...
public class HBW_1 extends Station {
    ...
    public HBW_1(String id, boolean i1_light_barrier, boolean i2_light_barrier, boolean i3_light_barrier,
                 boolean i4_light_barrier, boolean i5_pos_switch, boolean i6_pos_switch,
                 boolean i7_pos_switch,
                 boolean i8_pos_switch, double m1_speed, double m2_speed, double m3_speed, double m4_speed,
                 String current_state, String current_task, double current_task_duration, String current_sub_task, double current_pos_x, double current_pos_y, double target_pos_x, double target_pos_y, int amount_of_workpieces, Map<String, String> current_stock) {
        super(id);
    ...
    public double getAmount_of_workpieces() {
        return amount_of_workpieces;
    }

    public void setAmount_of_workpieces(double amount_of_workpieces) {
        this.amount_of_workpieces = amount_of_workpieces;
    }
